	...
	<div class="wrap js-check-wrap">
		...
		<form class="js-ajax-form" method="post">
			<div class="table-actions">
				...
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('slide/delete');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?></button>
			</div>
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($slides)): foreach($slides as $key=>$vo): ?><tr>
					...
					<td>
						<?php if(!empty($vo['slide_pic'])): ?><a href="<?php echo sp_get_image_preview_url($vo['slide_pic']);?>" target="_blank"><?php echo L('VIEW');?></a><?php endif; ?>
					</td>
