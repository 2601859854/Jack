	...
	<div class="wrap js-check-wrap">
		...
		<form class="js-ajax-form" method="post">
			<div class="table-actions">
				...
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('Commentadmin/delete');?>" data-subcheck="true" data-msg="<?php echo L('DELETE_CONFIRM_MESSAGE');?>"><?php echo L('DELETE');?></button>
			</div>
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($comments)): foreach($comments as $key=>$vo): ?><tr>
					...
					<td>
						<a target="_blank" href="/wtcms-master/<?php echo ($vo["url"]); ?>">查看原文</a> 
